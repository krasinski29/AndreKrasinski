...
def read_dataset():
    ...
    df = df.rename(columns = {'InvoiceNo':'invoice_id','StockCode': 'stock_code', 'Description':'description',
...
def data_pre_processing(df):
    ...
    rt = df.dropna(subset=["description","customer_id"]).reset_index(drop = True)
